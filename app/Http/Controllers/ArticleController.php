...
class ArticleController extends Controller
{
    ...
    public function getAdminCategories()
    {
        ...
        return view('admin-categories', ['categories' => $categories, 'title' => 'CMS Страница администратора | Категории', 'desc' => 'CMS Страница администратора | Категории']);
    }

    public function createAdminCategory()
    {
        return view('admin-add-category', ['title' => 'CMS Страница администратора | Создание категории', 'desc' => 'CMS Страница администратора | Создание категории']);
    }

    public function editAdminCategory($id)
    {
        $category = Category::where('id', $id)->first();
        return view('admin-edit-category', ['title' => 'CMS Страница администратора | Создание категории', 'desc' => 'CMS Страница администратора | Создание категории', 'category' => $category]);
    }
    ...
    public function getAdminArticles()
    {
        ...
        return view('admin-articles', ['articles' => $articles, 'title' => 'CMS Страница администратора | Статьи', 'desc' => 'CMS Страница администратора | Статьи']);
    }
    ...
    public function createAdminArticle()
    {
        ...
        return view('admin-add-article', ['title' => 'CMS Страница администратора | Создание статьи', 'desc' => 'CMS Страница администратора | Создание статьи', 'articles' => $articles, 'members' => $members, 'categories' => $categories]);
    }
    ...
    public function editAdminArticle($id)
    {
        ...
        return view('admin-edit-article', ['title' => 'CMS Страница администратора | Создание категории', 'desc' => 'CMS Страница администратора | Создание категории', 'article' => $article, 'members' => $members, 'categories' => $categories]);
    }
    ...
    public function getMemberArticles()
    {
        ...
        return view('member-articles', ['articles' => $articles, 'title' => 'CMS Страница администратора | Статьи', 'desc' => 'CMS Страница администратора | Статьи']);
    }
    ...
    public function createMemberArticle()
    {
        ...
        return view('member-add-article', ['title' => 'CMS Страница администратора | Создание статьи', 'desc' => 'CMS Страница администратора | Создание статьи', 'articles' => $articles, 'member' => $member, 'categories' => $categories]);
    }
    ...
    public function editMemberArticle($id)
    {
        ...
        return view('member-edit-article', ['title' => 'CMS Страница администратора | Создание категории', 'desc' => 'CMS Страница администратора | Создание категории', 'article' => $article, 'member' => $member, 'categories' => $categories]);
    }
