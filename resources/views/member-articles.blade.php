<x-admin-articles-layout :articles="$articles" :title="$title" :desc="$desc">
    ...
    <table>
      ...
      <tr>
        ...
        <td><a href="{{ route('articles.member-edit-articles', $article->id) }}" class="btn btn-primary}}">Edit</a></td>
        <td><a href="{{ route('articles.member-destroy-articles', $article->id) }}" class="btn btn-danger">Delete</a></td>
      </tr>
      @endforeach
      @else
        <tr>
